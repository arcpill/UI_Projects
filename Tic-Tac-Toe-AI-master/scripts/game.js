...
var Game = function(autoPlayer) {
	...
	/* Added a new variable to set the initial choice */
	this.initurn = "";
    /*
    ...
    this.advanceTo = function(_state) {
		...
		console.log("this.currentState.turn - "+ this.currentState.turn);
	 ...
	 /*
     * public function that advances the game to a new state for X or O
     * @param _state [State]: the new state to advance the game to
     */
    this.advanceTo2 = function(_state) {
        this.currentState = _state;
		//console.log("this.currentState.turn2 - "+ this.currentState.turn);
		//console.log("this.currentState.initurn2 - "+ this.initurn);
		
        if(_state.isTerminal()) {
            this.status = "ended";
			
            if(_state.result === "X-won" && this.initurn == "X" )
                //X won
                ui.switchViewTo("won");
            else if(_state.result === "O-won" && this.initurn == "O")
                //O won
                ui.switchViewTo("won");
			else if(_state.result === "X-won" && this.initurn == "O" )
                //O lost
                ui.switchViewTo("lost");
			else if(_state.result === "O-won" && this.initurn == "X" )
                //X lost
                ui.switchViewTo("lost");
            else
                //it's a draw
